...
public class CueFleschKincaidReadabilityIndex extends Cue {
	public CueFleschKincaidReadabilityIndex() {
		super("FleschKincaidReadabilityIndex", "Flesch-Kincaid Readability Index", " A readability tests designed to indicate how difficult a reading passage in English is to understand");
	}
	...
	public CueValue calculate(String textObservation) {
		...
		double readabilityIndex = FeaturesExtractor.getFleschKincaidGradeLevel(textObservation);
